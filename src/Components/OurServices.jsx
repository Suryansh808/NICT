    ...
    <React.Fragment>
      ...
      <Container fixed className="pt-[15vh] font-[Montserrat]">
        ...
        <div className='w-full pt-2 pb-20 mb-20'>
          <h1  data-aos='zoom-in' className='text-semibold text-2xl text-center mb-2'>Our Services</h1>
          <div className='flex gap-2'>
            <div  data-aos='zoom-in' className="card relative flex items-center justify-center w-[22vw] h-[40vh] bg-cover  bg-[url('https://images.unsplash.com/photo-1522071820081-009f0129c71c?w=400&auto=format&fit=crop&q=60&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8MTd8fGludGVybnxlbnwwfHwwfHx8MA%3D%3D')]  ">
            ...
            <div  data-aos='zoom-in' className=" relative card flex items-center justify-center w-[22vw] h-[40vh] bg-cover bg-[url('https://images.unsplash.com/photo-1531497082986-2422f7b87330?w=400&auto=format&fit=crop&q=60&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8MTE5fHxtbmMlMjBjb21wYW55fGVufDB8fDB8fHww')] ">
            <div className=' w-full h-full flex items-center justify-center hover:bg-[#0000006f] ease-linear duration-300'>
