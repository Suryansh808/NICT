...
const GoogleCertification = () => {
  ...
  return (
       <>
        <div className='bg-[#dadada] grid grid-cols-12 gap-2 p-2 font-[Montserrat]'>
            <div  className='bg-white border-2 col-span-12 rounded-md max-sm:col-span-12'>
              <div data-aos="zoom-in" className="heading flex items-center justify-center">
             ...
             <div data-aos="zoom-in" className="flex items-center gap-2 overflow-hidden justify-center w-full p-2 ">
            ...
            <div  className='bg-white border col-span-8  rounded-md max-sm:col-span-12'>
                    <h1 data-aos="zoom-in" className='flex items-center text-black text-2xl font-bold p-2 '><span><img className="w-[24vh]" src="http://www.nictcomputereducation.com/assets/home/microsoft.png" alt="MicroSoft" /></span>Certification</h1>   
                    <div data-aos="zoom-in" className='w-full h-[50vh] flex justify-center bg-no-repeat bg-center bg-cover	 bg-[url("https://images.unsplash.com/photo-1573167507387-6b4b98cb7c13?w=400&auto=format&fit=crop&q=60&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1yZWxhdGVkfDE3fHx8ZW58MHx8fHx8")]'>
                    ...
                    <h1 data-aos="zoom-in" className='text-2xl font-bold p-2 text-center'>Microsoft Office Specialist</h1>
                    <div data-aos="zoom-in" className='flex items-center justify-center flex-wrap '>
                    ...
                    <button data-aos="zoom-in" className="relative group cursor-pointer text-sky-50  overflow-hidden h-12 w-44 m-4 rounded-md bg-sky-800 p-2 flex justify-center items-center font-extrabold">
                    <div className="absolute top-3 right-20 group-hover:top-12 group-hover:-right-12 z-10 w-40 h-40 rounded-full group-hover:scale-150 group-hover:opacity-50 duration-500 bg-sky-900"></div>
                    <div className="absolute top-3 right-20 group-hover:top-12 group-hover:-right-12 z-10 w-32 h-32 rounded-full group-hover:scale-150 group-hover:opacity-50 duration-500 bg-sky-800"></div>
                    <div className="absolute top-3 right-20 group-hover:top-12 group-hover:-right-12 z-10 w-24 h-24 rounded-full group-hover:scale-150 group-hover:opacity-50 duration-500 bg-sky-700"></div>
                    <div className="absolute top-3 right-20 group-hover:top-12 group-hover:-right-12 z-10 w-14 h-14 rounded-full group-hover:scale-150 group-hover:opacity-50 duration-500 bg-sky-600"></div>
            ...
            <div className='bg-white col-span-4 p-2 rounded-md max-sm:col-span-12'>
               <h1  data-aos="fade-left">Why Students Love NICT?</h1>
               <div  data-aos="fade-left" className='w-full p-2'>
            ...
            <div  className='bg-white  pb-10 border col-span-12 p-5 rounded-md max-sm:col-span-12'>
               <h1 data-aos="zoom-in" className='text-2xl font-bold leading-tight tracking-tighter'>TALLY ERP9 with GST</h1>
               <div data-aos="zoom-in" className='w-full h-[60vh] bg-cover bg-no-repeat  bg-[url("https://www.antraweb.com/img/blog/tally-in-a-virtual-environment.png")] max-sm:w-[100%] max-sm:bg-contain max-sm:h-[25vh]'></div>
               <p data-aos="zoom-in" className='px-2 py-4 font-semibold'>To Meet the industry demand for Tally. <br /> 
